...
Route::middleware('auth:sanctum')->get('/user', function (Request $request) {
    ...
    Route::get("/v1/clientes",[ProductosController::class,"getAll"]);
    Route::get("/v1/clientes/{id}",[ProductosController::class,"getItem"]);
    Route::post("/v1/clientes",[ProductosController::class,"store"]);
    Route::put("/v1/clientes",[ProductosController::class,"update"]);
    Route::patch("/v1/clientes",[ProductosController::class,"patch"]);
    Route::delete("/v1/clientes/{id}",[ProductosController::class,"delete"]);
